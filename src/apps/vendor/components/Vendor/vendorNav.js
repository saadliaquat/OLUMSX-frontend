...
let navigation = [
    { name: 'Home', href: '/vendor', current: true },
    { name: 'Add Product', href: '/vendor/vendorAddProduct', current: false },
    { name: 'Products and Orders', href: '/vendor/vendorViewOrder', current: false },
    { name: 'Chat', href: '/vendor/vendorChat', current: false }
]
...
export default function Navbar({ currentPage }) {
    ...
    return (
        <Disclosure as="nav" className="fixed w-full top-0 z-20 montserrat bg-black">
            {({ open }) => (
                <>
                                                ...
                                                {({ active }) => (
                                                    <a
                                                        ...
                                                        onClick={(e) => {
                                                            ...
                                                            localStorage.clear();
                                                            // Hard reload to "/" so every section's in-memory
                                                            // state (Redux, cached trees) is fully reset.
