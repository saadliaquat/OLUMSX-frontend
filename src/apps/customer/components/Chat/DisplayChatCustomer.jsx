...
export default function DisplayChatCustomer(props) {
  const { vendorID } = props; // Destructure vendorID from props
  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-md flex flex-col w-full" style={{ minHeight: 'calc(100vh - 160px)' }}>
        {messages.length > 0 && (
