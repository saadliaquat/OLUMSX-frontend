...
function Profile() {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast.error(`Failed to update profile: ${responseData.message}`);
      }
    } catch (error) {
      console.error('Failed to update profile:', error);
      toast.error('Failed to update profile. Check console for more information.');
    }
  };
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 montserrat">
        {editMode ? (
          <div className="bg-white shadow-lg rounded-lg p-8 montserrat">
