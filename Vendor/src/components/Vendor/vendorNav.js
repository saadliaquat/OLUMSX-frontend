...
let navigation = [
    ...
    { name: 'Add Product', href: '/vendorAddProduct', current: false },
    { name: 'Products and Orders', href: '/vendorViewOrder', current: false },
    { name: 'Chat', href: '/vendorChat', current: false }
]
